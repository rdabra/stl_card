...
\begin{itemize}[leftmargin=*,topsep=0.25pt]
  \setlength\itemsep{-1.8pt}
\item  {\textbf{system\_clock}} @ $<$chrono$>$: represents the system's real time wall clock; 
\item  {\textbf{steady\_clock}} @ $<$chrono$>$: represents the system's clock since last boot; 
