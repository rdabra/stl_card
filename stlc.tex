...
\begin{itemize}[leftmargin=*,topsep=0.25pt]
  ...
  \item \textbf{span} @ $<$span$>$ (C++20): a non-owing view (reference) of contiguous sequence containers such as C array, \textbf{array}, \textbf{vector}, \textbf{string}. It can  reference these containers indiscriminately;
